    ...
    <div className="w-full flex flex-col items-center justify-center mt-6 md:my-12">
        <div className="w-11/12 md:w-10/12 flex items-center justify-between">
            <div className="flex items-center gap-2 md:gap-4">
                ...
                <h1 className="text-xs md:text-2xl font-bold">Adam Cooper Team</h1>
            </div>
            <div>
                <Link to='/new-project'>
                <button className="bg-black md:text-base text-sm text-white font-medium md:font-semibold px-2 md:px-4 py-1 rounded-md">New Project</button>
                </Link>
            </div>
        </div>
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
                <div className="rounded-md border-[1px]">
                    ...
                    <div className="mt-2 p-2">
                        ...
                        <h1 className="text-gray-500">updated 9 mar 24</h1>
                    </div>
                </div>
